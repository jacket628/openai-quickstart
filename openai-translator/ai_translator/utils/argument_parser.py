...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--source_language', type=str, help='The original language to be translated.')
        self.parser.add_argument('--target_language', type=str, help='The target language to be translated.')
